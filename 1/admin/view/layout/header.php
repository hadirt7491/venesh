            ...
            <ul class="nav top-menu">
                ...
                <li id="header_inbox_bar" class="dropdown">
                    ...
                    <ul class="dropdown-menu extended inbox">
                        ...
                        <li>
                            <a href="http://mvc/admin/?c=messages&a=list">نمایش تمامی پیام ها</a>
                        </li>
                    </ul>
                </li>
                <!-- inbox dropdown end -->
        ...
        <div id="sidebar"  class="nav-collapse ">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a class="" href="http://mvc/admin/?c=menu&a=list">لیست منو ها</a></li>
                        <li><a class="" href="http://mvc/admin/?c=menu&a=add">افزودن منو جدید</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a class="" href="http://mvc/admin/?c=services&a=list">لیست سرویس ها</a></li>
                        <li><a class="" href="http://mvc/admin/?c=services&a=add">افزودن سرویس جدید</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a class="" href="http://mvc/admin/?c=product_cat&a=list">لیست دسته بندی ها</a></li>
                        <li><a class="" href="http://mvc/admin/?c=product_cat&a=add">افزودن دسته بندی جدید</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a class="" href="http://mvc/admin/?c=product&a=list">لیست محصولات</a></li>
                        <li><a class="" href="http://mvc/admin/?c=product&a=add">افزودن محصول جدید</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a class="" href="http://mvc/admin/?c=service_flow&a=list">لیست سرویس فلو ها</a></li>
                        <li><a class="" href="http://mvc/admin/?c=service_flow&a=add">افزودن سرویس فلو جدید</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a class="" href="http://mvc/admin/?c=customers&a=list">لیست همکاران</a></li>
                        <li><a class="" href="http://mvc/admin/?c=customers&a=add">افزودن همکار جدید</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a class="" href="http://mvc/admin/?c=pages&a=list">لیست برگه ها</a></li>
                        <li><a class="" href="http://mvc/admin/?c=pages&a=add">افزودن برگه جدید</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a class="" href="http://mvc/admin/?c=article_cat&a=list">لیست دسته بندی</a></li>
                        <li><a class="" href="http://mvc/admin/?c=article_cat&a=add">افزودن دسته بندی جدید</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a class="" href="http://mvc/admin/?c=article&a=list">لیست مقاله ها</a></li>
                        <li><a class="" href="http://mvc/admin/?c=article&a=add">افزودن مقاله جدید</a></li>
                    </ul>
                </li>
