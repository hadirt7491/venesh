...
<section class="feature spad" id="customers_section">
    <div class="container">
        <div class="row">
            <div class="">
                            <div class="col-md-12 heading-section text-center ftco-animate customer-h">
                                <span class="subheading"></span>
                                <h2 class="mb-4 customer-h">همکاران</h2>
                            </div>
                <div class="row">
