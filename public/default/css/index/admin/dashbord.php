            ...
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href="dashbord.php?m=product_cat&p=list">لیست دسته بندی ها</a></li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href="dashbord.php?m=work-flow&p=list">لیست سرویس ها</a></li>
                            <li><a class="" href="dashbord.php?m=work-flow&p=add">افزودن سرویس جدید</a></li>
                        </ul>
                    </li>
